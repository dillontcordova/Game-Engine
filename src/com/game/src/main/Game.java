...
public class Game extends Canvas implements Runnable {
	...
	public void init() {
		...
		render = new FrameRender(bufferStrategy, HEIGHT*SCALE, WIDTH*SCALE);//rendering is taking place on its own thread FrameRender.java //TODO: Move to FrameRender Class
		render.startThread();
	}
